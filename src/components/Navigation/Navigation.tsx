          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav mx-auto">
              <li className="nav-item">
                <NavLink to="/" end className={({ isActive }) => isActive ? "nav-link active-link" : "nav-link"}>About Me</NavLink>
              </li>
              <li className="nav-item">
              ...
              <li className="nav-item">
                <NavLink to="/resume" className={({ isActive }) => isActive ? "nav-link active-link" : "nav-link"}>Resume</NavLink>
              </li>
            </ul>
          </div>
        </div>
